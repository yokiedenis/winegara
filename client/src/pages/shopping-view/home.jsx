...
const categoriesWithIcon = [
  { id: "Red Wine", label: "Red Wine", icon: Wine },
  { id: "White Wine", label: "White Wine", icon: Wine },
  { id: "Sparkling", label: "Sparkling", icon: Grape },
  { id: "Non-Alcoholic", label: "Non-Alcoholic", icon: CupSoda },
  { id: "Whiskey and Spirits", label: "Whiskey and Spirits", icon: Martini },
  { id: "Beer", label: "Beer", icon: Beer },
];

const brandsWithIcon = [
  { id: "local wines", label: "local wines", icon: Wine },
  { id: "imported wines", label: "imported wines", icon: Grape },
...
function ShoppingHome() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="relative w-full h-[35vh] sm:h-[300px] md:h-[400px] lg:h-[500px] ">
